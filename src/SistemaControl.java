public class SistemaControl {
    ...
    public boolean enviar_respuesta_accion(int id,String mensaje){
        ...
        if (Global.log) System.out.println("Sistema de control del módulo " + modulo_propietario.get_referencia() + " enviando acción a seguir");
    ...
    public String gestionar_solucion(){
        ...
        if (Global.log) System.out.println("Gestionando solución en módulo " + modulo_propietario.get_referencia());
        return "Solución gestionada";
    }

    public void interpretar(String mensaje){
        if (Global.log) System.out.println("Interpretando mensaje en módulo " + modulo_propietario.get_referencia() + ": " + mensaje);
